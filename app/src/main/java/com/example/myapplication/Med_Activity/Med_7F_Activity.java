...
public class Med_7F_Activity extends AppCompatActivity {
    ...
    private void moving_704() {
        final Button button = (Button) findViewById(R.id.med_704);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (flag == 0) {
                    {
                        ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX",  1040, 1040, 1320, 1320, 1420);
                        animation1.setDuration(2100);
                        animation1.start();

                        ObjectAnimator animation3 = ObjectAnimator.ofFloat(iv, "translationY",  400, 470, 470, 590, 590);
    ...
    private void moving_705() {
        final Button button = (Button) findViewById(R.id.med_705);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (flag == 0) {
                    {
                        ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1200, 1200, 1320, 1320, 1420);
    ...
    private void moving_706() {
        final Button button = (Button) findViewById(R.id.med_706);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (flag == 0) {
                    {
                        ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1320, 1320, 1420);
                        animation1.setDuration(1900);
                        animation1.start();

                        ObjectAnimator animation3 = ObjectAnimator.ofFloat(iv, "translationY", 300, 590, 590);
                        animation3.setDuration(1900);
                        animation3.start();
                    }
                    flag = 1;
    ...
    private void moving_707() {
        final Button button = (Button) findViewById(R.id.med_707);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (flag == 0) {
            {
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1430, 1430, 1320, 1320, 1420);
                animation1.setDuration(1800);
                animation1.start();
