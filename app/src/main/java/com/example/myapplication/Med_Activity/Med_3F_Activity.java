...
public class Med_3F_Activity extends AppCompatActivity {
    ...
    private void moving_304() {
        final Button button = (Button) findViewById(R.id.med_304);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (flag == 0) {
                    {
                        ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX",  570,570);
    ...
    private void moving_305() {
        final Button button = (Button) findViewById(R.id.med_305);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (flag == 0) {
                    {
                        ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 780, 780, 570, 570);
    ...
    private void moving_306() {
        final Button button = (Button) findViewById(R.id.med_306);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (flag == 0) {
                    {
                        ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 970, 970, 1280, 1280, 1370);
                        animation1.setDuration(1900);
                        animation1.start();
    ...
    private void moving_307() {
        final Button button = (Button) findViewById(R.id.med_307);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (flag == 0) {
            {
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1170, 1170, 1280, 1280, 1370);
                animation1.setDuration(1800);
                animation1.start();
