...
public class Music_6F_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Music_6F_Activity.myView1 mview1= new Music_6F_Activity.myView1(fl1.getContext());
        fl1.addView(mview1);
        fl1.setVisibility(View.GONE);

        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        Music_6F_Activity.myView2 mview2= new Music_6F_Activity.myView2(fl2.getContext());
        fl2.addView(mview2);
        fl2.setVisibility(View.GONE);

        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        Music_6F_Activity.myView3 mview3= new Music_6F_Activity.myView3(fl3.getContext());
        fl3.addView(mview3);
        fl3.setVisibility(View.GONE);

        final FrameLayout fl4 = (FrameLayout)findViewById(R.id.fl4);
        Music_6F_Activity.myView4 mview4= new Music_6F_Activity.myView4(fl4.getContext());
        fl4.addView(mview4);
        fl4.setVisibility(View.GONE);

        final FrameLayout fl5 = (FrameLayout)findViewById(R.id.fl5);
        Music_6F_Activity.myView5 mview5= new Music_6F_Activity.myView5(fl5.getContext());
        fl5.addView(mview5);
        fl5.setVisibility(View.GONE);

        final FrameLayout fl6 = (FrameLayout)findViewById(R.id.fl6);
        Music_6F_Activity.myView6 mview6= new Music_6F_Activity.myView6(fl6.getContext());
        fl6.addView(mview6);
        fl6.setVisibility(View.GONE);

        final FrameLayout fl7 = (FrameLayout)findViewById(R.id.fl7);
        Music_6F_Activity.myView7 mview7= new Music_6F_Activity.myView7(fl7.getContext());
        fl7.addView(mview7);
        fl7.setVisibility(View.GONE);

        final FrameLayout fl8 = (FrameLayout)findViewById(R.id.fl8);
        Music_6F_Activity.myView8 mview8= new Music_6F_Activity.myView8(fl8.getContext());
        fl8.addView(mview8);
        fl8.setVisibility(View.GONE);

        final FrameLayout fl9 = (FrameLayout)findViewById(R.id.fl9);
        Music_6F_Activity.myView9 mview9= new Music_6F_Activity.myView9(fl9.getContext());
        fl9.addView(mview9);
        fl9.setVisibility(View.GONE);


        final FrameLayout flf = (FrameLayout)findViewById(R.id.flf);
        Music_6F_Activity.finalView finalview= new Music_6F_Activity.finalView(flf.getContext());
        ...
        switchButton.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(SwitchButton view, boolean isChecked) {
                ...
                if(isChecked) {
                    Toast.makeText(Music_6F_Activity.this,"모든 대피로", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Music_6F_Activity.this,"경로 리셋", Toast.LENGTH_SHORT).show();
    ...
    public class myView7 extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1640,350);
            path.lineTo(1740,350);
    ...
    public class myView8 extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1640,530);
            path.lineTo(1640,350);
            path.lineTo(1740,350);
