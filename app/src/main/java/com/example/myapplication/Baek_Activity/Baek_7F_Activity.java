...
public class Baek_7F_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchButton.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(SwitchButton view, boolean isChecked) {
                ...
                if(isChecked) {
                    Toast.makeText(Baek_7F_Activity.this,"모든 대피로", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Baek_7F_Activity.this,"경로 리셋", Toast.LENGTH_SHORT).show();
    ...
    public class FL1View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(740,540);
            path.lineTo(1300,540);
            path.lineTo(1300,370);
            path.lineTo(1210,370);
    ...
    public class FL2View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1140,830);
            path.lineTo(1240,830);
    ...
    public class FL7View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1390,750);
            path.lineTo(1240,750);
            path.lineTo(1240,540);
            path.lineTo(1300,540);
            path.lineTo(1300,370);
            path.lineTo(1210,370);
    ...
    public class FL8View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1815,550);
            path.lineTo(1815,370);
    ...
    public class finalView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            path.moveTo(1300,540);
            path.lineTo(1815,540);
            path.lineTo(1815,370);
